...
int ack::getDll_packetType() const
{
    return this->Dll_packetType;
}

void ack::setDll_packetType(int Dll_packetType)
{
    this->Dll_packetType = Dll_packetType;
}

int ack::getDll_packetId() const
{
    return this->Dll_packetId;
}

void ack::setDll_packetId(int Dll_packetId)
{
...
ackDescriptor::ackDescriptor() : omnetpp::cClassDescriptor("ack", "omnetpp::cPacket")
{
